...
int main(int argc, char** argv)
{
    ...
    */
    ...
    const char picture[3][300] = {"https://www.wikihow.com/images/thumb/d/db/Get-the-URL-for-Pictures-Step-2-Version-6.jpg/v4-460px-Get-the-URL-for-Pictures-Step-2-Version-6.jpg.webp",
   "https://d27jswm5an3efw.cloudfront.net/app/uploads/2019/07/how-to-make-a-url-for-a-picture-on-your-computer-4.jpg",
   "https://cdn2.hubspot.net/hubfs/53/parts-url.jpg"};
    ...
    for(int f = 0; f < 4; f++) //test voor 3 afbeeldingen
    {
      // Open image
      int width, height, componentCount;
      printf("Loading png file...\r\n");
      unsigned char* inputData = stbi_load(picture[f], &width, &height, &componentCount, 4);
      if (!inputData)
      {
